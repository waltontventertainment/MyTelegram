...
public class BuildVars {
    ...
    // ⚠️ এখানে আপনার আসল API ID বসান (কোনো কোটেশন ছাড়া, শুধু সংখ্যা)
    public static int APP_ID = 37418913; 
    
    // ⚠️ এখানে ডাবল কোটেশনের ভেতরে আপনার আসল API Hash বসান
    public static String APP_HASH = "432ec7d053fc19e15f78b7db0e305f8b";

    // SafetyNet key disabled for custom fork — forces regular SMS verification
    ...
    // 🚀 কাস্টম ফোর্কের জন্য SMS হ্যাশ রিমুভ করা হয়েছে যাতে স্বাভাবিকভাবে কোড আসে
