...
public class ThemeColors {
    ...
    public static final int TELEGRAM_COLOR = 0xFF8B5CF6;         // FeelWire Neon Purple
    public static final int TELEGRAM_COLOR_TEXT = 0xFF7C3AED;   // FeelWire Deep Purple
    public static final int DEFAULT_BLACK_TEXT = 0xFFE8E8F0;    // FeelWire Light Text
    ...
    public static int[] createDefaultColors() {
        ...
        defaultColors[key_dialogBackground] = 0xFF1C1C2E;
        defaultColors[key_dialogBackgroundGray] = 0xFF13131F;
        ...
        defaultColors[key_windowBackgroundWhite] = 0xFF1C1C2E;
        defaultColors[key_windowBackgroundUnchecked] = 0xFF4A4A6A;
        defaultColors[key_windowBackgroundChecked] = 0xFF8B5CF6;
        ...
        defaultColors[key_windowBackgroundWhiteHintText] = 0xFF6060A0;
        ...
        defaultColors[key_windowBackgroundWhiteInputField] = 0xFF2A2A42;
        ...
        defaultColors[key_windowBackgroundGray] = 0xFF13131F;
        defaultColors[key_windowBackgroundGrayShadow] = 0xff000000;
        defaultColors[key_emptyListPlaceholder] = 0xFF6060A0;
        defaultColors[key_divider] = 0xFF2A2A45;
        defaultColors[key_graySection] = 0xFF13131F;
        defaultColors[key_graySectionText] = 0xFF7070A0;
        ...
        defaultColors[key_actionBarDefault] = 0xFF0F0F1A;
        defaultColors[key_actionBarDefaultIcon] = 0xFFE0E0F0;
        defaultColors[key_actionBarActionModeDefault] = 0xFF1A1A2E;
        defaultColors[key_actionBarActionModeDefaultTop] = 0x30000000;
        defaultColors[key_actionBarActionModeDefaultIcon] = 0xFFE0E0F0;
        defaultColors[key_actionBarDefaultTitle] = 0xFFE8E8F0;
        defaultColors[key_actionBarDefaultSubtitle] = 0xFF9090B0;
        defaultColors[key_actionBarDefaultSelector] = 0x288B5CF6;
        defaultColors[key_actionBarWhiteSelector] = 0x288B5CF6;
        defaultColors[key_actionBarDefaultSearch] = 0xFFE0E0F0;
        defaultColors[key_actionBarDefaultSearchPlaceholder] = 0xFF6060A0;
        defaultColors[key_actionBarDefaultSubmenuItem] = 0xFFE0E0F0;
        defaultColors[key_actionBarDefaultSubmenuItemIcon] = 0xFFB0B0D0;
        defaultColors[key_actionBarDefaultSubmenuBackground] = 0xFF252540;
        defaultColors[key_actionBarDefaultSubmenuSeparator] = 0xFF1A1A2E;
        defaultColors[key_actionBarActionModeDefaultSelector] = 0xFF2A2A40;
        ...
        defaultColors[key_chats_name] = 0xFFE8E8F0;
        defaultColors[key_chats_nameArchived] = 0xFFB0B0D0;
        defaultColors[key_chats_secretName] = 0xff4bcb1c;
        defaultColors[key_chats_secretIcon] = 0xff4bcb1c;
        defaultColors[key_chats_pinnedIcon] = 0xFF6060A0;
        defaultColors[key_chats_message] = 0xFF9090A8;
        defaultColors[key_chats_messageArchived] = 0xFF7070A0;
        defaultColors[key_chats_message_threeLines] = 0xFF8080A0;
        defaultColors[key_chats_draft] = 0xFFFF6B6B;
        defaultColors[key_chats_nameMessage] = TELEGRAM_COLOR_TEXT;
        defaultColors[key_chats_nameMessageArchived] = 0xFF7070A0;
        defaultColors[key_chats_nameMessage_threeLines] = 0xFFB0B0D0;
        defaultColors[key_chats_nameMessageArchived_threeLines] = 0xFF8080A0;
        defaultColors[key_chats_attachMessage] = TELEGRAM_COLOR_TEXT;
        defaultColors[key_chats_actionMessage] = TELEGRAM_COLOR_TEXT;
        defaultColors[key_chats_date] = 0xFF7070A0;
        defaultColors[key_chats_date_bold] = 0xFF8080B0;
        ...
        defaultColors[key_chats_menuBackground] = 0xFF1C1C2E;
        defaultColors[key_chats_menuItemText] = 0xFFE0E0F0;
        defaultColors[key_chats_menuItemCheck] = 0xFF8B5CF6;
        defaultColors[key_chats_menuItemIcon] = 0xFF8080A8;
        defaultColors[key_chats_menuName] = 0xFFE8E8F0;
        defaultColors[key_chats_menuPhone] = 0xFFB0B0D0;
        ...
        defaultColors[key_chat_inBubble] = 0xFF252540;
        defaultColors[key_chat_inBubbleSelected] = 0xFF2D2D55;
        defaultColors[key_chat_inBubbleShadow] = 0xFF0A0A18;
        defaultColors[key_chat_outBubble] = 0xFF4A1FA8;
        defaultColors[key_chat_outBubbleGradientSelectedOverlay] = 0x20FFFFFF;
        defaultColors[key_chat_outBubbleSelected] = 0xFF5A2EC0;
        defaultColors[key_chat_outBubbleShadow] = 0xFF1A0A40;
        ...
        defaultColors[key_chat_messageTextIn] = 0xFFE8E8F0;
        defaultColors[key_chat_messageTextOut] = 0xFFFFFFFF;
        defaultColors[key_chat_messageLinkIn] = 0xFF9D7EFF;
        defaultColors[key_chat_messageLinkOut] = 0xFFCCB8FF;
        ...
        defaultColors[key_chat_outSentCheck] = 0xFFCCB8FF;
        defaultColors[key_chat_outSentCheckSelected] = 0xFFDDD0FF;
        defaultColors[key_chat_outSentCheckRead] = 0xFFCCB8FF;
        defaultColors[key_chat_outSentCheckReadSelected] = 0xFFDDD0FF;
        defaultColors[key_chat_outSentClock] = 0xFFB0A0E0;
        defaultColors[key_chat_outSentClockSelected] = 0xFFB0A0E0;
        ...
        defaultColors[key_chat_outViews] = 0xFFCCB8FF;
        defaultColors[key_chat_outViewsSelected] = 0xFFDDD0FF;
        defaultColors[key_chat_mediaViews] = 0xffffffff;
        defaultColors[key_chat_inMenu] = 0xFF8080B0;
        defaultColors[key_chat_inMenuSelected] = 0xFF9090C0;
        defaultColors[key_chat_outMenu] = 0xFFCCB8FF;
        defaultColors[key_chat_outMenuSelected] = 0xFFDDD0FF;
        defaultColors[key_chat_mediaMenu] = 0xffffffff;
        defaultColors[key_chat_outInstant] = 0xFFCCB8FF;
        defaultColors[key_chat_outInstantSelected] = 0xFFDDD0FF;
        defaultColors[key_chat_inInstant] = TELEGRAM_COLOR_TEXT;
        defaultColors[key_chat_inInstantSelected] = 0xFF9D7EFF;
        ...
        defaultColors[key_chat_outReplyLine] = 0xFFCCB8FF;
        defaultColors[key_chat_outReplyLine2] = 0xFFB0A0E0;
        defaultColors[key_chat_stickerReplyLine] = 0xffffffff;
        defaultColors[key_chat_inReplyNameText] = TELEGRAM_COLOR_TEXT;
        defaultColors[key_chat_outReplyNameText] = 0xFFDDD0FF;
        defaultColors[key_chat_stickerReplyNameText] = 0xffffffff;
        defaultColors[key_chat_inReplyMessageText] = 0xFFD0D0E8;
        defaultColors[key_chat_outReplyMessageText] = 0xFFE8E4FF;
        defaultColors[key_chat_inReplyMediaMessageText] = 0xFF8080A8;
        defaultColors[key_chat_outReplyMediaMessageText] = 0xFFB0A8D8;
        defaultColors[key_chat_inReplyMediaMessageSelectedText] = 0xFF9090B8;
        defaultColors[key_chat_outReplyMediaMessageSelectedText] = 0xFFCCB8FF;
        ...
        defaultColors[key_chat_inTimeText] = 0xFF8080A8;
        defaultColors[key_chat_inTimeSelectedText] = 0xFF9090B8;
        defaultColors[key_chat_outTimeText] = 0xFFCCB8FF;
        defaultColors[key_chat_outTimeSelectedText] = 0xFFDDD0FF;
        ...
        defaultColors[key_chat_messagePanelBackground] = 0xFF1C1C2E;
        defaultColors[key_chat_messagePanelText] = 0xFFE8E8F0;
        defaultColors[key_chat_messagePanelHint] = 0xFF6060A0;
        defaultColors[key_chat_messagePanelCursor] = 0xFF8B5CF6;
